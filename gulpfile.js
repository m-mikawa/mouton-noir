...
gulp.task('build',
    gulp.series(
        gulp.series('remove-packages', 'packages'),
        gulp.series('remove-images', 'img'),
        gulp.series('remove-css', 'css',)
    )
);
...
gulp.task('default', gulp.series('build', function () {
    gulp.watch(dir.src.css + '/**/*.scss', gulp.task('css'));
    // gulp.watch(dir.src.js + '/**/*.js', gulp.task('uglify'));
    gulp.watch(dir.src.img + '/**', gulp.task('img'));
}));
